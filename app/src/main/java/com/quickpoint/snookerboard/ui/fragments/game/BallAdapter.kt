...
import com.quickpoint.snookerboard.ui.fragments.game.BallAdapter.ViewHolder.Companion.singleItemSelectionPosition
...
class BallAdapter(
    ...
    private var oldList: List<DomainBall> = emptyList()
