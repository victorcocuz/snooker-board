...
enum class MatchAction {
    ...
    // Match Actions
    MATCH_START_DIALOG, // Action that starts match
    ...
    MATCH_END_QUERY, // Open match ending dialog
    MATCH_ENDED_DISCARD_FRAME, // On clicking the conceding button when the current play can affect who wins
